...
const HomePage = () => {
  return (
    <div className="bg-blanco min-h-screen flex flex-col w-full">
      ...
      <div className="relative h-[690px]"> {/* Cambié h-screen a h-3/4 */}
        <Image 
          src={fondo} 
          alt="Imagen de fondo" 
      ...
      {/* Contenedor para el fondo inferior */}
      <div className="relative z-0">
        <Image 
          ...
          className="absolute inset-0 w-full h-full object-cover z-0" 
        />
        <div className="relative z-10 text-center py-6"> {/* Añadido text-center y py-8 */}
